...
static mrb_value ts_mrb_get_conn_var_remote_addr(mrb_state *mrb, mrb_value self)
{
...
static mrb_value ts_mrb_get_conn_var_remote_port(mrb_state *mrb, mrb_value self)
{
  TSMrubyContext* context = reinterpret_cast<TSMrubyContext *>(mrb->ud);
  Transaction* transaction = context->transaction;
...
static mrb_value ts_mrb_get_conn_var_server_addr(mrb_state *mrb, mrb_value self)
{
  TSMrubyContext* context = reinterpret_cast<TSMrubyContext *>(mrb->ud);
  Transaction* transaction = context->transaction;
...
static mrb_value ts_mrb_get_conn_var_server_port(mrb_state *mrb, mrb_value self)
{
  TSMrubyContext* context = reinterpret_cast<TSMrubyContext *>(mrb->ud);
  Transaction* transaction = context->transaction;
...
void ts_mrb_connection_class_init(mrb_state *mrb, struct RClass *rclass)
{
  ...
  // Connection::
  class_conn = mrb_define_class_under(mrb, rclass, "Connection", mrb->object_class);
